...
public class UUID {
    ...
    public static String getUserPK() {
        return "user~" + captchaChar(15, false);
    }
     ...
     * @return 随机字符串
     */
    public static String getVideoGroupPK() {
        return "avg" + captchaChar(8, false);
    }
     ...
     * @return 随机字符串
     */
    public static String getPicturePipelined() {
        return "pic_" + captchaChar(28, false);
    }
     ...
     * @return 随机字符串
     */
    public static String getVideoPipelined() {
        return "av_" + captchaChar(29, false);
    }
}